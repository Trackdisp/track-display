...
RSpec.describe Measure, type: :model do
  ...
  describe '#Validations' do
    it { should validate_numericality_of(:avg_age).is_greater_than_or_equal_to(0) }
    it { should validate_numericality_of(:presence_duration).is_greater_than_or_equal_to(0) }
    it { should validate_numericality_of(:contact_duration).is_greater_than_or_equal_to(0) }
    it do
      should validate_numericality_of(:happiness).is_greater_than_or_equal_to(0)
                                                 .is_less_than_or_equal_to(1)
    end

    it { should validate_presence_of(:measured_at) }
    it { should validate_presence_of(:w_id) }
